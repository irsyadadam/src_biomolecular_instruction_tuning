#!/bin/bash
# DEEPSPEED_pretrain_node_proteomics.sh
...
OUTPUT_DIR="/path/to/node_llm/pretrain"

# Model Configuration
LLM_VERSION="lmsys/vicuna-7b-v1.5"
VISION_TOWER="node_encoder"
