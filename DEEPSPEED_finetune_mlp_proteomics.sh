...
PRETRAINED_MODEL_PATH="/local/irsyadadam/biomolecular_instruction_tuning_data/mlp_llm/pretrain"
...
# QLoRA optimized hyperparameters
PER_DEVICE_BATCH_SIZE=160     # Even larger batch due to 8-bit quantization
GRAD_ACCUM_STEPS=1           
